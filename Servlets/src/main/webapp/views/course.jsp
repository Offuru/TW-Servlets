...
<div class="course-container">
    ...
    <form action="${pageContext.request.contextPath}/course" method="post">
        ...
        <div class="form-group">
            ...
            <input type="number" id="course-credits" name="courseCredits" placeholder="Enter number of credits" min="1" max="30" required>
        </div>
    ...
    <p>Return to <a href="${pageContext.request.contextPath}/home">Courses</a>.</p>
</div>
</body>
</html>
